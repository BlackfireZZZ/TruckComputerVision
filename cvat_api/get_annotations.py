...
CVAT_API_URL = PrivateConfig.CVAT_API_URL
...
def download_annotations(job_id: str, cookies):
    ...
    if response.status_code == 200:
        ...
        raise Exception(f"Failed to download annotations: {response.status_code}, {response.text}")
...
if __name__ == "__main__":
    username = PrivateConfig.CVAT_LOGIN
    password = PrivateConfig.CVAT_PASSWORD
